...
class AppSettingsViewController: UIViewController {
    @IBOutlet var notificationLabel1: UILabel!
    @IBOutlet var datePicker: UIDatePicker!
    @IBOutlet var notificationDateLabel: UILabel!
    @IBOutlet var changeDateButton: UIButton!
    @IBOutlet var confirmDateButton: UIButton!
    @IBOutlet var notificationSwitchObject: UISwitch!
